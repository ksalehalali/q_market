...
Future getLatestProducts()async{
  latestProducts.value = [
    ProductModel('1', 'iphone 12', 'آيفون١٢', 'a1', 'https://media.istockphoto.com/photos/newly-released-iphone-12-purple-color-mockup-set-with-different-picture-id1313990743', 3000.000,2900.000,'256 GB' ,'Apple',['128 GB','256 GB','512']),
